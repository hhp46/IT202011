...
<ul class="nav">
    ...
    <?php endif; ?>
      <?php if (has_role("Admin")): ?>
            ...
            <li><a href="<?php echo getURL("test/test_list_survey.php"); ?>">View Surveys</a></li>
            <li><a href="<?php echo getURL("test/test_create_question.php"); ?>">Create Questions</a></li>
            <li><a href="<?php echo getURL("test/test_list_question.php"); ?>">View Questions</a></li>
