...
$db = getDB();
$stmt = $db->prepare("SELECT id, title FROM Survey WHERE  (SELECT count(1) from Responses where user_id = :id and survey_id = Survey.id) = 0 order by created desc LIMIT 10");
